...
export function Header({ image_gif, titreParagraph, titreText, image_langue }) {
    return (
        <div className="md:px-[70px] bg-[#FCFCFD] md:py-9 ">
            <div className="md:flex md:w-[100%] flex-row-reverse md:mb-10 md:h-[337px] h-[350px] md:justify-evenly md:w:[100%] justify-center items-center flex px-5">
                <div className="md:w-[350px] flex justify-center items-center"> <Image src={image_gif} alt="image" width="400" height="400" /> </div>
                <div>
                    <div className="md:w-[237px] w-[137px]"> <Image src={image_langue} alt="image" width="150" height="150" /> </div>
